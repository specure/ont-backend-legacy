...
public abstract class ResourceManager {
    ...
    // system messages
    private static final String BASE_NAME_SYSTEM_MESSAGES = "com.specure.rmbt.shared.res.SystemMessages";
    // countries
    private static final String BASE_NAME_COUNTRIES = "com.specure.rmbt.shared.res.Countries";
    //customer based configuration
    private static final String BASE_NAME_CONFIG = "com.specure.rmbt.shared.res.customer.Configuration";
    ...
    public static ResourceBundle getCountries(Locale locale) {
        return getBundle(BASE_NAME_COUNTRIES, locale);
    }

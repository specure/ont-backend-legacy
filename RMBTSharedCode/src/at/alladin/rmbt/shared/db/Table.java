...
import at.alladin.rmbt.shared.db.repository.RMBTRepository;
...
/**
 * @deprecated use the new {@link RMBTRepository} for database access
 */
public abstract class Table implements FieldAccess {
    protected long uid;

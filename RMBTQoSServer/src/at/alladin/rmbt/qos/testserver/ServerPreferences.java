...
public class ServerPreferences {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ServerPreferences.class);
    ...
    public ServerPreferences() throws TestServerException {
        logger.info("ServerPreferences...");
        loadFromConfigFile("config.properties");
        setUdpPortSet();
        checkConstraints();
        logger.info("ServerPreferences... DONE");
    }
        ...
        try {
            ...
            while (e.hasMoreElements()) {
                ...
                while (ee.hasMoreElements()) {
                    ...
                    if (!inetAddrBindToSet.contains(i) && !i.isLoopbackAddress() && !i.isLinkLocalAddress()) {
                        logger.debug("Adding interface: {},  isAnyLocalAddress: {}, isLinkLocalAddress(): {}, isLoopbackAddress(): {}, isSiteLocalAddress(): {}, isMulticastAddress(): {}",
                                i.getHostAddress(), i.isAnyLocalAddress(), i.isLinkLocalAddress(),
                                i.isLoopbackAddress(), i.isSiteLocalAddress(), i.isMulticastAddress());
                        inetAddrBindToSet.add(i);
                    }
                }
            }

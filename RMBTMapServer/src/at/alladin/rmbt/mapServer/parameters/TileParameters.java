...
public abstract class TileParameters implements Funnel<TileParameters> {
    ...
    // logger instance
    private static final Logger logger = LoggerFactory.getLogger(TileParameters.class);

    private static final long serialVersionUID = -9091474853518399688L;
    ...
    public final static class Path implements Funnel<Path> {
        private static final long serialVersionUID = 1666193835632535138L;

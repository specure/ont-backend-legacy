...
public class InfoResourceV2 extends ServerResource {

    // logger instance
    private static final Logger logger = LoggerFactory.getLogger(InfoResourceV2.class);
    ...
    private JSONArray getMapTypeList() throws JSONException {
        final boolean isRatelCustomer = customerName.toLowerCase().equals("ratel");
    ...
    private JSONArray getMapLayoutsList() throws JSONException {
        ...
        // Basic
        obj = new JSONObject();
        obj.put("title", labels.getString("MAP_FILTER_BASIC"));
        obj.put("default", true);
        obj.put("apiLink", settings.getString("BASIC_API_LINK"));
        obj.put("accessToken", settings.getString("BASIC_ACCESS_TOKEN"));
        obj.put("layer", settings.getString("BASIC_LAYER"));
        result.put(obj);

        // Streets
        obj = new JSONObject();
        obj.put("title", labels.getString("MAP_FILTER_STREETS"));
        obj.put("apiLink", settings.getString("STREETS_API_LINK"));
        obj.put("accessToken", settings.getString("STREETS_ACCESS_TOKEN"));
        obj.put("layer", settings.getString("STREETS_LAYER"));
        result.put(obj);

        // Satellite
        obj = new JSONObject();
        obj.put("title", labels.getString("MAP_FILTER_SATELLITE"));
        obj.put("apiLink", settings.getString("SATTELITE_API_LINK"));
        obj.put("accessToken", settings.getString("SATTELITE_ACCESS_TOKEN"));
        obj.put("layer", settings.getString("SATTELITE_LAYER"));
        result.put(obj);
